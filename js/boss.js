...
Boss.prototype = {
	...
	create : function() {
		this.sprite = this.game.add.sprite(100, 310, 'shroomLord');
		this.sprite.anchor.setTo(0.5, 0);
		game.physics.enable(this.sprite, Phaser.Physics.ARCADE);
		this.sprite.body.setSize(300, 10, 150, -30);
		...
		this.sprite.moveTween = game.add.tween(this.sprite.body)
			.to({ x: 524 }, 1500, Phaser.Easing.Quadratic.In)
			.to(null, 250, Phaser.Easing.Linear.None)
			.to({ x: 100 }, 1500, Phaser.Easing.Quadratic.In)
			.to(null, 250, Phaser.Easing.Linear.None)
			.loop()
			.start();
		...
		this.sprite.killTween = game.add.tween(this.sprite.body)
			.to({ y: this.sprite.y-100 }, 800, Phaser.Easing.Quadratic.Out)
			.to({ y: 1200 }, 1200, Phaser.Easing.Quadratic.In)

		this.sprite.hurtTween = game.add.tween(this.sprite.body)
